...
public class Simple {
    ...
    public int power(int base, int exp) {
        int ans = 1;
        for (int i = 1; i <= exp; i++) {
            ans *= base;        // The base was being multiplied by 1 exp times.
            // Rather, we want the answer to be multiplied by the base exp times to get base^exp.
        }
        return ans;     // This returned the unchanged base.
        // I return ans since ans stands for answer, and it does actually contain the answer.
    }
